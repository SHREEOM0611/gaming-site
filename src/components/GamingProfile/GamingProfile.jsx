...
const GamingProfile = () => (
    ...
    <div className='GamingProfile'>
        ...
        <div className='profile'>
            ...
            <h1 className='videoList'>My Videos</h1>
            <div className='gamerProfileVideos'>
                <div className="myVideoCard">
                    <iframe width="560"
                        height="415"
                        src="https://www.youtube.com/embed/qpVFLB5noLc"
                        title="YouTube video player"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
                    <div className="myVideo_details">
                        <p className="video_owner">
                            Apathy
                        </p>
                        <p className="myVideoViews">
                            Views: 10,786
                        </p>
                    </div>
                </div>
                ...
                <div className="myVideoCard">
                    <iframe width="560"
                        height="415"
                        src="https://www.youtube.com/embed/iQuoUwbJsD4"
                        title="YouTube video player"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
                ...
                <div className="myVideoCard">
                    <iframe width="560"
                        height="415"
                        src="https://www.youtube.com/embed/-SOj9UZYtvo"
                        title="YouTube video player"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
